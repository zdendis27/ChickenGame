...
public GamePanelMenu(mainFrame.Frame frame) {
    ...
    StyledMenuItem exitItem = new StyledMenuItem("Exit To Main game.Menu", exitIcon);
    StyledMenuItem helpItem = new StyledMenuItem("other.Help", helpIcon);
